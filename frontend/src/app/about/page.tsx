...
export default function AboutPage() {
  ...
  return (
    <>
      <Head>
        <title>About – CoStudy</title>
        <meta name="description" content="Learn how CoStudy helps students focus together online." />
      </Head>

      <main className="min-h-screen flex flex-col bg-[rgb(70,60,102)] text-[#f2f7fd] overflow-x-hidden select-none">
        <Header />
