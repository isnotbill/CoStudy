        ...
        <FieldGroup>
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            >
              ...
              <span className="sr-only">costudy</span>
            </Link>
            <div className="flex items-center gap-2">
              <h1 className="text-xl font-bold">Welcome to</h1>
              <h1 style={{ fontFamily: 'var(--font-cedarville)'}} className="text-3xl">costudy</h1>
            </div>
          ...
          <Field>
            <Button type="submit">{loading ? <Loader className="animate-spin" /> : "Login"}</Button>
            {loginErrors && (
          ...
          <FieldSeparator className=""></FieldSeparator>
